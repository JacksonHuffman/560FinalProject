...
namespace ApplicationDMV.InsertForms
{
    public partial class GoToUpdateLicenseForm : Form
    {
        ...
        private void uxGoToUpdateBT_Click(object sender, EventArgs e)
        {
            ...
            QueryResultForm resultForm = new QueryResultForm(completeDrivers, completeVehicles, completeLiList, regDriverSearchForm, vehicleSearchForm, licenseInformationSearchForm, false, false);
